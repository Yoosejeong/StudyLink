      ...
      <div class="space-y-4 p-6">
        ...
        {:else}
          {#each applicants as applicant}
            <div class="flex w-full items-center justify-between rounded-lg border p-4 transition-colors hover:bg-gray-50">
              <!-- 왼쪽 -->
              <div class="flex flex-1 items-center gap-4">
                {#if avatarSrc(applicant)}
                  ...
                  />
                {:else}
                  <div class="flex h-12 w-12 shrink-0 select-none items-center justify-center rounded-full bg-gray-200 text-sm font-semibold text-gray-700">
