    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        .requestMatchers("/api/login", "/api/s3/presign/**", "/api/logout/", "/api/signUp","/api/study-posts","/api/reissue","/v3/api-docs/**","/swagger-ui/**","/swagger-ui.html", "/actuator/health").permitAll()
